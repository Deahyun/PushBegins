...
$(document).ready( function() {
	...
	$("#register").click( function() {
		...
		//
		json_data["io_kind"] = "send_gcm_all_push_req";
	...
	$.ajax({
		...
		success: function(response) {
			...
			if ( result == "yes" ) {
				$("#message").html("<font color=blue>google push 를 전송했습니다.</font>");
				setTimeout(function() {
					$("#push_alert").val("");
					$("#push_message").val("");
					$("#message").html("");
				...
				$("#message").html("<font color=red>google push 를 전송중 오류가 발생 했습니다.</font>");
				setTimeout(function() {
					$("#message").html("");
				}, 3000);
			}
