...
<body>
	<div class="wrapper">
		...
		<section class="popular-recipes">
			...
			<a class="current">전체 push 메시지 보내기</a>
		...
		<ul>
			<h2><font color="green">기기종류별 전체 push 메시지 보내기</font></h2><p>
		</ul>
		<ul>
			<p id="message"></p>
		</ul>
		...
		<ul>
			<li><a href="121_gcm_push_list2.jsp?user_seq=<%=strUserSeq%>">google push 보내기</a></li>
			<li><a href="122_apns_push_list2.jsp?user_seq=<%=strUserSeq%>">apple push 보내기</a></li>
		</ul>
