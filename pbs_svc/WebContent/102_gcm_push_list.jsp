...
<div class="wrapper">
		...
		<ul>
			<h2><font color="green">등록된 google push</font></h2><p>
		</ul>
		<ul>
			<p id="message"></p>
		</ul>
		...
		<%
			...
			for ( int i = 0; i < resList.size(); i++ ) {
				...
				String strText = String.format("<font color=green>%s</font> ( project number: %s | api key: %s )",
						info.push_name, info.proj_num, info.api_key);
